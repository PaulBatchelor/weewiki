...
#+END_SRC
* TODO Create
Note: WIP idea. This will slightly change the behavior
of weewiki such that weewiki's will need to be explicitely
created before running any other commands.

=create= creates an a weewiki database in the currently
